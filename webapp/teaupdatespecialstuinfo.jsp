...
function uup() {
	...
	if(siaddress == "") {
		...
		$.ajax({
			method : "POST",
			async : true,
			url : "UpdateThisSpecialStuController.mvc",
...
<body class="withvernav">
	...
	<div class="bodywrapper">
		...
		<div style="position: absolute;top: 200px;left: 600px	">
			您正在修改${sessionScope.specialsnum}的个人信息<br/>
			<form method="post">
			省市:<select id="province" name="province"></select> <select id="city" name="city"></select><br />
			详细地址: <input id="siaddress" name="siaddress" type="text" placeholder="请输入你的详细地址" style="width: 250px;"><br /> 
			身份证:<input id="siidcard" name="siidcard" type="text" placeholder="请输入你的身份证" style="width: 250px;"><br /> <hr /> 
			</form>
			<input type="button" value="提交" onclick="uup()">
