			...
			<div class="left_tab">
				...
				<div class="bd">
					<div class="box">
						...
						<ul class="clearfix">
							<li><a href="n2Detail.html"><img src="images/a2.png" /><h4>教务运行公告</h4><span class="date">2018-12-17</span></a></li>
							<li><a href="nDetail.html"><img src="images/a1.png" /><h4>聆听2014级的毕业心声</h4><span class="date">2018-12-11</span></a></li>
							<li><a href="n2Detail.html"><img src="images/a3.jpg" /><h4>预期授课会议</h4><span class="date">2018-12-01</span></a></li>
							<li><a href="n2Detail.html"><img src="images/a4.jpg" /><h4>校领导视察会议</h4><span class="date">2018-11-25</span></a></li>
							<li><a href="n2Detail.html"><img src="images/a5.jpg" /><h4>学校宣讲会</h4><span class="date">2018-11-20</span></a></li>
						</ul>
					</div>
					<div class="box">
						<a href="secret.html" class="more">MORE+</a>
						<ul class="clearfix">
							<li><a href="secret.html"><img src="images/s1.jpg" /><h4>艺术学院老师工作日常</h4><span class="date">2018-12-14</span></a></li>
							<li><a href="secret.html"><img src="images/s2.jpg" /><h4>XXX老师演讲式课堂风格</h4><span class="date">2018-12-13</span></a></li>
							<li><a href="secret.html"><img src="images/s3.jpg" /><h4>机电学院老师调研会</h4><span class="date">2018-12-11</span></a></li>
						</ul>
					</div>
					<div class="box">
						<a href="news.html" class="more">MORE+</a>
						<ul class="clearfix">
							<li><a href="rDetail.html"><img src="images/n1.png" /><h4>2017级外语学院新生入学</h4><span class="date">2018-12-20</span></a></li>
							<li><a href="rDetail.html"><img src="images/n2.jpg" /><h4>体育学院地市级运动会</h4><span class="date">2018-12-02</span></a></li>
							<li><a href="rDetail.html"><img src="images/n3.jpg" /><h4>医学院临床实习</h4><span class="date">2018-11-29</span></a></li>
							<li><a href="rDetail.html"><img src="images/n4.jpg" /><h4>软件工程学院XX公司宣讲会</h4><span class="date">2018-11-02</span></a></li>
